...
public class AsyncScalr {
	 ...
	 */
	public static final @Dimensionless String THREAD_COUNT_PROPERTY_NAME = "imgscalr.async.threadCount";
	 ...
	 */
	public static final @Dimensionless int THREAD_COUNT = Integer.getInteger(
			((@Dimensionless String) (THREAD_COUNT_PROPERTY_NAME)), ((@Dimensionless int) (2)));

	/**
	 * Initializer used to verify the THREAD_COUNT system property.
	 */
	static {
		if (THREAD_COUNT < ((@Dimensionless int) (1)))
			throw new @Dimensionless RuntimeException("System property '"
					+ ((@Dimensionless String) (THREAD_COUNT_PROPERTY_NAME)) + "' set THREAD_COUNT to "
					+ THREAD_COUNT + ", but THREAD_COUNT must be > 0.");
	}

	protected static @Dimensionless ExecutorService service;
	 ...
	 *         scale operations.
	 */
	public static @Dimensionless ExecutorService getService() {
		return service;
	}
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> apply(final @Dimensionless BufferedImage src,
			final @Dimensionless BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
		checkService();

		return service.submit(new @Dimensionless Callable<@Dimensionless BufferedImage>() {
			public @Dimensionless BufferedImage call() throws Exception {
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> crop(final @Dimensionless BufferedImage src,
			final @Dimensionless int width, final @Dimensionless int height, final @Dimensionless BufferedImageOp @Dimensionless ... ops)
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> crop(final @Dimensionless BufferedImage src,
			final @Dimensionless int x, final @Dimensionless int y, final @Dimensionless int width, final @Dimensionless int height,
			final @Dimensionless BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> pad(final @Dimensionless BufferedImage src,
			final @Dimensionless int padding, final @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> pad(final @Dimensionless BufferedImage src,
			final @Dimensionless int padding, final @Dimensionless Color color, final @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> resize(final @Dimensionless BufferedImage src,
			final @Dimensionless int targetSize, final @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> resize(final @Dimensionless BufferedImage src,
			final @Dimensionless Method scalingMethod, final @Dimensionless int targetSize,
			final @Dimensionless BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> resize(final @Dimensionless BufferedImage src,
			final @Dimensionless Mode resizeMode, final @Dimensionless int targetSize,
			final @Dimensionless BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> resize(final @Dimensionless BufferedImage src,
			final @Dimensionless Method scalingMethod, final @Dimensionless Mode resizeMode,
			final @Dimensionless int targetSize, final @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> resize(final @Dimensionless BufferedImage src,
			final @Dimensionless int targetWidth, final @Dimensionless int targetHeight,
			final @Dimensionless BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> resize(final @Dimensionless BufferedImage src,
			final @Dimensionless Method scalingMethod, final @Dimensionless int targetWidth,
			final @Dimensionless int targetHeight, final @Dimensionless BufferedImageOp @Dimensionless ... ops) {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> resize(final @Dimensionless BufferedImage src,
			final @Dimensionless Mode resizeMode, final @Dimensionless int targetWidth,
			final @Dimensionless int targetHeight, final @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
		checkService();
	 ...
	 */
	public static @Dimensionless Future<@Dimensionless BufferedImage> rotate(final @Dimensionless BufferedImage src,
			final @Dimensionless Rotation rotation, final @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
		checkService();
	...
	protected static @Dimensionless ExecutorService createService() {
		return createService(new @Dimensionless DefaultThreadFactory());
	}

	protected static @Dimensionless ExecutorService createService(@Dimensionless ThreadFactory factory)
			throws IllegalArgumentException {
		if (factory == null)
			throw new @Dimensionless IllegalArgumentException("factory cannot be null");
	...
	protected static class DefaultThreadFactory implements ThreadFactory {
		protected static final @Dimensionless AtomicInteger poolNumber = new @Dimensionless AtomicInteger(((@Dimensionless int) (1)));

		protected final @Dimensionless ThreadGroup group;
		protected final @Dimensionless AtomicInteger threadNumber = new @Dimensionless AtomicInteger(((@Dimensionless int) (1)));
		protected final @Dimensionless String namePrefix;
		 ...
		 */
		public @Dimensionless Thread newThread(AsyncScalr.@Dimensionless DefaultThreadFactory this, @Dimensionless Runnable r) {
			/*
			 * Create a new thread in our specified group with a meaningful
			 * thread name so it is easy to identify.
			 */
			@Dimensionless
			Thread thread = new @Dimensionless Thread(group, r, namePrefix
					+ threadNumber.getAndIncrement(), ((@Dimensionless int) (0)));

			// Configure thread according to class or subclass
			thread.setDaemon(false);
			thread.setPriority(((@Dimensionless int) (Thread.NORM_PRIORITY)));
	...
	protected static class ServerThreadFactory extends DefaultThreadFactory {
		 ...
		 */
		@Override
		public @Dimensionless Thread newThread(AsyncScalr.@Dimensionless ServerThreadFactory this, @Dimensionless Runnable r) {
			@Dimensionless
			Thread thread = super.newThread(r);

			thread.setDaemon(true);
			thread.setPriority(((@Dimensionless int) (Thread.MIN_PRIORITY)));

			return thread;
		}
	public ServerThreadFactory(AsyncScalr.@Dimensionless ServerThreadFactory this) { super(); }
	}
}