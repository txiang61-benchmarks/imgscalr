...
public class Scalr {
	 ...
	 */
	public static final @Dimensionless String DEBUG_PROPERTY_NAME = "imgscalr.debug";
	 ...
	 */
	public static final @Dimensionless String LOG_PREFIX_PROPERTY_NAME = "imgscalr.logPrefix";
	 ...
	 */
	public static final @Dimensionless boolean DEBUG = Boolean.getBoolean(((@Dimensionless String) (DEBUG_PROPERTY_NAME)));
	 ...
	 */
	public static final @Dimensionless String LOG_PREFIX = System.getProperty(
			((@Dimensionless String) (LOG_PREFIX_PROPERTY_NAME)), "[imgscalr] ");
	 ...
	 * @since 3.0
	 */
	public static final @Dimensionless ConvolveOp OP_ANTIALIAS = new @Dimensionless ConvolveOp(
			new @Dimensionless Kernel(((@Dimensionless int) (3)), ((@Dimensionless int) (3)), new @Dimensionless float @Dimensionless [] { ((@Dimensionless float) (.0f)), ((@Dimensionless float) (.08f)), ((@Dimensionless float) (.0f)), ((@Dimensionless float) (.08f)), ((@Dimensionless float) (.68f)), ((@Dimensionless float) (.08f)),
					((@Dimensionless float) (.0f)), ((@Dimensionless float) (.08f)), ((@Dimensionless float) (.0f)) }), ((@Dimensionless int) (ConvolveOp.EDGE_NO_OP)), null);
	 ...
	 * @since 4.0
	 */
	public static final @Dimensionless RescaleOp OP_DARKER = new @Dimensionless RescaleOp(((@Dimensionless float) (0.9f)), ((@Dimensionless int) (0)), null);
	 ...
	 * @since 4.0
	 */
	public static final @Dimensionless RescaleOp OP_BRIGHTER = new @Dimensionless RescaleOp(((@Dimensionless float) (1.1f)), ((@Dimensionless int) (0)), null);
	 ...
	 * @since 4.0
	 */
	public static final @Dimensionless ColorConvertOp OP_GRAYSCALE = new @Dimensionless ColorConvertOp(
			ColorSpace.getInstance(((@Dimensionless int) (ColorSpace.CS_GRAY))), null);
	 ...
	 */
	static {
		log(((@Dimensionless int) (0)), "Debug output ENABLED");
	}
	...
	public static enum Method {
		 ...
		 * {@link Method#QUALITY}).
		 */
		@Dimensionless ULTRA_QUALITY;
	public Method(Scalr.@Dimensionless Method this) { super(); }
	}
	...
	public static enum Rotation {
		 ...
		 */
		@Dimensionless FLIP_VERT;
	public Rotation(Scalr.@Dimensionless Rotation this) { super(); }
	}
	 ...
	 */
	public static final @Dimensionless int THRESHOLD_BALANCED_SPEED = ((@Dimensionless int) (1600));
	 ...
	 */
	public static final @Dimensionless int THRESHOLD_QUALITY_BALANCED = ((@Dimensionless int) (800));
	 ...
	 *             operations.
	 */
	public static @Dimensionless BufferedImage apply(@Dimensionless BufferedImage src, @Dimensionless BufferedImageOp @Dimensionless ... ops)
	  ...
	  if (DEBUG)
		...
		if (src == null)
			throw new @Dimensionless IllegalArgumentException("src cannot be null");
		if (ops == null || ops.length == ((@Dimensionless int) (0)))
			throw new @Dimensionless IllegalArgumentException("ops cannot be null or empty");
		 ...
		 */
		if (!(type == ((@Dimensionless int) (BufferedImage.TYPE_INT_RGB)) || type == ((@Dimensionless int) (BufferedImage.TYPE_INT_ARGB))))
			src = copyToOptimalImage(src);

		if (DEBUG)
			log(((@Dimensionless int) (0)), "Applying %d BufferedImageOps...", ops.length);

		@Dimensionless
		boolean hasReassignedSrc = false;

		for (@Dimensionless int i = ((@Dimensionless int) (0)); i < ops.length; i++) {
      @ms
      long subT = ((@ms int) (-1));
      if (DEBUG)
        subT = System.currentTimeMillis();
			...
			if (DEBUG)
				log(((@Dimensionless int) (1)), "Applying BufferedImageOp [class=%s, toString=%s]...",
			...
			if (resultBounds == null)
				throw new @Dimensionless ImagingOpException(
						"BufferedImageOp ["
								+ op.toString()
			...
			BufferedImage dest = createOptimalImage(src,
					(@Dimensionless int) Math.round(resultBounds.getWidth()),
					(@Dimensionless int) Math.round(resultBounds.getHeight()));
		...
		if (DEBUG)
			log(((@Dimensionless int) (0)), "All %d BufferedImageOps applied in %d ms", ops.length,
	 ...
	 *             operations.
	 */
	public static @Dimensionless BufferedImage crop(@Dimensionless BufferedImage src, @Dimensionless int width, @Dimensionless int height,
			@Dimensionless
			BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
		return crop(src, ((@Dimensionless int) (0)), ((@Dimensionless int) (0)), width, height, ops);
	}
	 ...
	 *             operations.
	 */
	public static @Dimensionless BufferedImage crop(@Dimensionless BufferedImage src, @Dimensionless int x, @Dimensionless int y,
			@Dimensionless
			int width, @Dimensionless int height, @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
    @ms
    long t = ((@ms int) (-1));
    if (DEBUG)
      t = System.currentTimeMillis();
		...
		if (src == null)
			throw new @Dimensionless IllegalArgumentException("src cannot be null");
		if (x < ((@Dimensionless int) (0)) || y < ((@Dimensionless int) (0)) || width < ((@Dimensionless int) (0)) || height < ((@Dimensionless int) (0)))
			throw new @Dimensionless IllegalArgumentException("Invalid crop bounds: x [" + x
		 ...
		 * region).
		 */
		g.drawImage(src, ((@Dimensionless int) (0)), ((@Dimensionless int) (0)), width, height, x, y, (x + width), (y + height),
				null);
		g.dispose();

		if (DEBUG)
			log(((@Dimensionless int) (0)), "Cropped Image in %d ms", System.currentTimeMillis() - t);
	 ...
	 *             operations.
	 */
	public static @Dimensionless BufferedImage pad(@Dimensionless BufferedImage src, @Dimensionless int padding,
			@Dimensionless
			BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
	...
	public static @Dimensionless BufferedImage pad(@Dimensionless BufferedImage src, @Dimensionless int padding,
			@Dimensionless
			Color color, @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
    @ms
    long t = ((@ms int) (-1));
    if (DEBUG)
      t = System.currentTimeMillis();
		...
		if (src == null)
			throw new @Dimensionless IllegalArgumentException("src cannot be null");
		if (padding < ((@Dimensionless int) (1)))
			throw new @Dimensionless IllegalArgumentException("padding [" + padding
					+ "] must be > 0");
		if (color == null)
			throw new @Dimensionless IllegalArgumentException("color cannot be null");
		 ...
		 */
		@Dimensionless
		int sizeDiff = (padding * ((@Dimensionless int) (2)));
		@Dimensionless
		...
		@Dimensionless
		boolean colorHasAlpha = (color.getAlpha() != ((@Dimensionless int) (255)));
		@Dimensionless
		boolean imageHasAlpha = (src.getTransparency() != ((@Dimensionless int) (BufferedImage.OPAQUE)));
		...
		if (colorHasAlpha || imageHasAlpha) {
			...
			result = new @Dimensionless BufferedImage(newWidth, newHeight,
					((@Dimensionless int) (BufferedImage.TYPE_INT_ARGB)));
		} else {
			if (DEBUG)
				log(((@Dimensionless int) (1)),
			...
			result = new @Dimensionless BufferedImage(newWidth, newHeight,
					((@Dimensionless int) (BufferedImage.TYPE_INT_RGB)));
		}
		...
		g.setColor(color);
		g.fillRect(((@Dimensionless int) (0)), ((@Dimensionless int) (0)), newWidth, newHeight);
		...
		if (DEBUG)
			log(((@Dimensionless int) (0)), "Padding Applied in %d ms", System.currentTimeMillis() - t);
	 ...
	 *             operations.
	 */
	public static @Dimensionless BufferedImage resize(@Dimensionless BufferedImage src, @Dimensionless int targetSize,
			@Dimensionless
			BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
	 ...
	 * @see Method
	 */
	public static @Dimensionless BufferedImage resize(@Dimensionless BufferedImage src, @Dimensionless Method scalingMethod,
			@Dimensionless
			int targetSize, @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
	 ...
	 * @see Mode
	 */
	public static @Dimensionless BufferedImage resize(@Dimensionless BufferedImage src, @Dimensionless Mode resizeMode,
			@Dimensionless
			int targetSize, @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
	...
	public static @Dimensionless BufferedImage resize(@Dimensionless BufferedImage src, @Dimensionless Method scalingMethod,
			@Dimensionless
			Mode resizeMode, @Dimensionless int targetSize, @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
	 ...
	 *             operations.
	 */
	public static @Dimensionless BufferedImage resize(@Dimensionless BufferedImage src, @Dimensionless int targetWidth,
			@Dimensionless
			int targetHeight, @Dimensionless BufferedImageOp @Dimensionless ... ops)
			throws IllegalArgumentException, ImagingOpException {
	...
	public static @Dimensionless BufferedImage resize(@Dimensionless BufferedImage src, @Dimensionless Method scalingMethod,
			@Dimensionless
			int targetWidth, @Dimensionless int targetHeight, @Dimensionless BufferedImageOp @Dimensionless ... ops) {
	...
	public static @Dimensionless BufferedImage resize(@Dimensionless BufferedImage src, @Dimensionless Method scalingMethod,
			@Dimensionless
			Mode resizeMode, @Dimensionless int targetWidth, @Dimensionless int targetHeight,
			@Dimensionless
			BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
    @ms
    ...
    if (DEBUG)
      t = System.currentTimeMillis();
		...
		if (src == null)
			throw new @Dimensionless IllegalArgumentException("src cannot be null");
		if (targetWidth < ((@Dimensionless int) (0)))
			throw new @Dimensionless IllegalArgumentException("targetWidth must be >= 0");
		if (targetHeight < ((@Dimensionless int) (0)))
			throw new @Dimensionless IllegalArgumentException("targetHeight must be >= 0");
		...
		@Dimensionless
		float ratio = ((@Dimensionless float) currentHeight / (@Dimensionless float) currentWidth);

		if (DEBUG)
			log(((@Dimensionless int) (0)),
					"Resizing Image [size=%dx%d, resizeMode=%s, orientation=%s, ratio(H/W)=%f] to [targetSize=%dx%d]",
					currentWidth, currentHeight, resizeMode,
					(ratio <= ((@Dimensionless int) (1)) ? "Landscape/Square" : "Portrait"), ratio,
		...
		if (resizeMode == Mode.FIT_EXACT) {
			...
			@Dimensionless
			float requestedHeightScaling = ((@Dimensionless float) targetHeight / (@Dimensionless float) currentHeight);
			@Dimensionless
			float requestedWidthScaling = ((@Dimensionless float) targetWidth / (@Dimensionless float) currentWidth);
			@Dimensionless
			float actualScaling = Math.min(requestedHeightScaling, requestedWidthScaling);

			targetHeight = Math.round((@Dimensionless float) currentHeight * actualScaling);
			targetWidth = Math.round((@Dimensionless float) currentWidth * actualScaling);

			if (targetHeight == currentHeight && targetWidth == currentWidth)
				return src;

			if (DEBUG)
				log(((@Dimensionless int) (1)), "Auto-Corrected width and height based on scalingRatio %d.", actualScaling);
		} else {
			if ((ratio <= ((@Dimensionless int) (1)) && resizeMode == Mode.AUTOMATIC)
				 ...
				 * targetWidth.
				 */
				targetHeight = Math.round((@Dimensionless float) targetWidth * ratio);
				 ...
				 */
				targetWidth = Math.round((@Dimensionless float) targetHeight / ratio);
		...
		if (DEBUG)
			log(((@Dimensionless int) (1)), "Using Scaling Method: %s", scalingMethod);
		...
		if (DEBUG)
			log(((@Dimensionless int) (0)), "Resized Image in %d ms", System.currentTimeMillis() - t);
	 ...
	 * @see Rotation
	 */
	public static @Dimensionless BufferedImage rotate(@Dimensionless BufferedImage src, @Dimensionless Rotation rotation,
			@Dimensionless
			BufferedImageOp @Dimensionless ... ops) throws IllegalArgumentException,
			ImagingOpException {
    @ms
    ...
    if (DEBUG)
      t = System.currentTimeMillis();
		...
		if (src == null)
			throw new @Dimensionless IllegalArgumentException("src cannot be null");
		if (rotation == null)
			throw new @Dimensionless IllegalArgumentException("rotation cannot be null");

		if (DEBUG)
			log(((@Dimensionless int) (0)), "Rotating Image [%s]...", rotation);
		 ...
		 */
		@Dimensionless
		AffineTransform tx = new @Dimensionless AffineTransform();
		...
		case CW_90:
			...
			tx.translate(newWidth, ((@Dimensionless int) (0)));
			tx.rotate(Math.toRadians(((@deg int) (90))));
		...
		case CW_270:
			...
			tx.translate(((@Dimensionless int) (0)), newHeight);
			tx.rotate(Math.toRadians(((@deg int) (-90))));
			break;

		case CW_180:
			tx.translate(newWidth, newHeight);
			tx.rotate(Math.toRadians(((@deg int) (180))));
			break;

		case FLIP_HORZ:
			tx.translate(newWidth, ((@Dimensionless int) (0)));
			tx.scale(- ((@Dimensionless double) (1.0)), ((@Dimensionless double) (1.0)));
			break;
		...
		@Dimensionless
		Graphics2D g2d = (@Dimensionless Graphics2D) result.createGraphics();
		...
		if (DEBUG)
			log(((@Dimensionless int) (0)), "Rotation Applied in %d ms, result [width=%d, height=%d]",
	 ...
	 */
	protected static void log(@Dimensionless int depth, @Dimensionless String message, @UnknownUnits Object @Dimensionless ... params) {
		if (Scalr.DEBUG) {
			System.out.print(Scalr.LOG_PREFIX);

			for (@Dimensionless int i = ((@Dimensionless int) (0)); i < depth; i++)
				System.out.print("\t");
	 ...
	 */
	protected static @Dimensionless BufferedImage createOptimalImage(@Dimensionless BufferedImage src) {
	...
	protected static @Dimensionless BufferedImage createOptimalImage(@Dimensionless BufferedImage src,
			@Dimensionless
			int width, @Dimensionless int height) throws IllegalArgumentException {
		if (width < ((@Dimensionless int) (0)) || height < ((@Dimensionless int) (0)))
			throw new @Dimensionless IllegalArgumentException("width [" + width
					+ "] and height [" + height + "] must be >= 0");

		return new @Dimensionless BufferedImage(
				width,
				height,
				(src.getTransparency() == ((@Dimensionless int) (Transparency.OPAQUE)) ? ((@Dimensionless int) (BufferedImage.TYPE_INT_RGB))
						: ((@Dimensionless int) (BufferedImage.TYPE_INT_ARGB))));
	}
	 ...
	 *             if <code>src</code> is <code>null</code>.
	 */
	protected static @Dimensionless BufferedImage copyToOptimalImage(@Dimensionless BufferedImage src)
			throws IllegalArgumentException {
		if (src == null)
			throw new @Dimensionless IllegalArgumentException("src cannot be null");
		...
		@Dimensionless
		int type = (src.getTransparency() == ((@Dimensionless int) (Transparency.OPAQUE)) ? ((@Dimensionless int) (BufferedImage.TYPE_INT_RGB))
				: ((@Dimensionless int) (BufferedImage.TYPE_INT_ARGB)));
		@Dimensionless
		BufferedImage result = new @Dimensionless BufferedImage(src.getWidth(),
				src.getHeight(), type);

		// Render the src image into our new optimal source.
		@Dimensionless
		Graphics g = result.getGraphics();
		g.drawImage(src, ((@Dimensionless int) (0)), ((@Dimensionless int) (0)), null);
		g.dispose();
	 ...
	 */
	protected static @Dimensionless Method determineScalingMethod(@Dimensionless int targetWidth,
			@Dimensionless
			int targetHeight, @Dimensionless float ratio) {
		// Get the primary dimension based on the orientation of the image
		@Dimensionless
		int length = (ratio <= ((@Dimensionless int) (1)) ? targetWidth : targetHeight);
		...
		if (length <= ((@Dimensionless int) (Scalr.THRESHOLD_QUALITY_BALANCED)))
			result = Method.QUALITY;
		else if (length <= ((@Dimensionless int) (Scalr.THRESHOLD_BALANCED_SPEED)))
			result = Method.BALANCED;

		if (DEBUG)
			log(((@Dimensionless int) (2)), "AUTOMATIC scaling method selected: %s", result.name());
	 ...
	 */
	protected static @Dimensionless BufferedImage scaleImage(@Dimensionless BufferedImage src,
			@Dimensionless
			int targetWidth, @Dimensionless int targetHeight, @Dimensionless Object interpolationHintValue) {
		...
		resultGraphics.drawImage(src, ((@Dimensionless int) (0)), ((@Dimensionless int) (0)), targetWidth, targetHeight, null);
	 ...
	 *         hint.
	 */
	protected static @Dimensionless BufferedImage scaleImageIncrementally(@Dimensionless BufferedImage src,
			@Dimensionless
			int targetWidth, @Dimensionless int targetHeight, @Dimensionless Method scalingMethod,
			@Dimensionless
			Object interpolationHintValue) {
		@Dimensionless
		boolean hasReassignedSrc = false;
		@Dimensionless
		int incrementCount = ((@Dimensionless int) (0));
		@Dimensionless
		int currentWidth = src.getWidth();
		@Dimensionless
		int currentHeight = src.getHeight();
		 ...
		 */
		@Dimensionless
		int fraction = (scalingMethod == Method.ULTRA_QUALITY ? ((@Dimensionless int) (7)) : ((@Dimensionless int) (2)));
		...
		do {
			...
			if (DEBUG)
				log(((@Dimensionless int) (2)), "Scaling from [%d x %d] to [%d x %d]", prevCurrentWidth,
		...
		if (DEBUG)
			log(((@Dimensionless int) (2)), "Incrementally Scaled Image in %d steps.", incrementCount);
